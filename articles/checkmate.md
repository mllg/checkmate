...
```
    ...
    ##    r(x) 3.396 3.557 112.88434  3.647 3.7770 10906.359   100
    ##   cm(x) 2.364 2.465  34.21290  2.540 2.6850  3026.725   100
    ##  cmq(x) 1.643 1.743  10.78292  1.804 1.8635   857.530   100
...
```
    ...
    ## Unit: microseconds
    ##    expr    min     lq     mean  median      uq      max neval
    ##    r(x) 12.323 13.069 49.96042 13.3345 13.6905 3540.263   100
    ##   cm(x)  5.681  5.986 15.70318  6.1965  6.3520  855.204   100
    ##  cmq(x)  7.153  7.329 15.84275  7.4590  7.6045  821.472   100
...
```
    ...
    ## Unit: microseconds
    ##    expr     min       lq      mean  median       uq      max neval
    ##    r(x) 274.622 275.6995 308.10923 276.285 285.2370 2598.486   100
    ##   cm(x)  85.560  86.1010  97.79024  86.872  87.6380  896.983   100
    ##  cmq(x)  94.397  94.5915 105.71358  94.977  95.6435 1048.785   100
...
```
    ...
    ## Unit: microseconds
    ##    expr    min      lq     mean  median     uq      max neval
    ##    r(x) 66.615 68.0570 99.05511 68.7935 70.587 2824.207   100
    ##   cm(x) 35.396 36.0425 50.08555 36.9090 37.726 1064.145   100
    ##  cmq(x) 28.803 29.0390 37.29141 29.3700 29.575  778.072   100
...
```
    ...
    ## Unit: microseconds
    ##    expr    min      lq     mean median      uq     max neval
    ##    r(x) 56.285 57.0865 59.78932 57.868 60.2670 107.461   100
    ##   cm(x)  4.950  5.3505  6.52122  6.177  6.8430  35.716   100
    ##  cmq(x)  1.052  1.1870  1.56346  1.418  1.8085   6.432   100
...
```
    ...
    ## Unit: microseconds
    ##          expr    min     lq     mean median     uq      max neval
    ##     r(x.sexp) 26.299 26.890 48.98459 27.121 27.381 2181.989   100
    ##    cm(x.sexp) 11.492 11.782 22.84224 12.012 12.273 1078.451   100
    ##   r(x.altrep) 33.072 35.942 37.01636 36.188 36.458   59.922   100
    ##  cm(x.altrep)  3.616  3.952  5.36762  4.203  4.488   96.440   100
