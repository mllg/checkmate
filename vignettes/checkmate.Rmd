...
All functions are categorized into objects to check on the [package help page](https://mllg.github.io/checkmate/checkmate-package).
...
```
The respective counterparts to the `check`-function can be created using the constructors [makeAssertionFunction](https://mllg.github.io/checkmate/makeAssertion), [makeTestFunction](https://mllg.github.io/checkmate/makeTest) and [makeExpectationFunction](https://mllg.github.io/checkmate/makeExpectation):
```{r}
# For assertions:
