...
As a result, checkmate is sometimes slower while checking small vectors or scalar values, but on the other hand, you save a lot of time because you don't have to write hundreds of lines of code just to check some inputs.
