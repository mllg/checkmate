...
As a result, checks on scalars or small vectors are not necessarily faster with checkmate than with regular R functions (yet you still have to write much more code to implement these checks yourself).
