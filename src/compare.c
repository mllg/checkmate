...
inline Rboolean ii_ne(const R_len_t x, const R_len_t y) { return x != y; }

inline Rboolean dd_eq(const double x, const double y) { return x == y; }
...
inline Rboolean dd_ne(const double x, const double y) { return x != y; }
